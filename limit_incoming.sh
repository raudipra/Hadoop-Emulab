...
slowDevice(){
	...
	# filter by ip
	sudo tc filter add dev $1 parent 1:0 protocol ip u32 match ip dst 0.0.0.0/0 flowid 1:3
	sudo tc filter add dev $1 parent 1:0 protocol ip u32 match ip src 0.0.0.0/0 flowid 1:3
    # done
}
# ===============================================================================================================
# MAIN
